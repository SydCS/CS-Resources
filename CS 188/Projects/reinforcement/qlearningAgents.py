...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        #     if action == None:
        #         action = a
        #     elif self.getQValue(state, a) > self.getQValue(state, action):
        #         action = a
        #     elif self.getQValue(state, a) == self.getQValue(state, action):
        ...
        optimal_actions = [
            action for action in actions if self.getQValue(state, action) == max_q
        ]
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        """
        "*** YOUR CODE HERE ***"
        self.qVals[(state, action)] = (1 - self.alpha) * self.getQValue(
            state, action
